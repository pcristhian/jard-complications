                                            ...
                                            {sucursalSeleccionada && (
                                                <div className="flex items-center space-x-1">
                                                    ...
                                                    <span className="text-sm text-gray-600">
                                                        Sucursal: <span className="font-semibold">{sucursalSeleccionada.nombre}</span>
                                                    </span>
                                                </div>
                                            )}
                        ...
                        >
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                ...
                                <motion.div variants={itemVariants} className="space-y-2">
                                    ...
                                    <motion.input
                                        ...
                                        className={`w-full px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 ${errors.codigo
                                ...
                                <motion.div variants={itemVariants} className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <motion.input
                                            ...
                                            onChange={handleChange}
                                            className={`w-full pl-8 pr-4 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 ${errors.precio
                                                    ? 'border-red-300 bg-red-50 text-red-900'
                                                    : 'border-gray-300 bg-gray-50 text-gray-900'
                                                }`}
                                            placeholder="0.00"
                                ...
                                <motion.div variants={itemVariants} className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <motion.input
                                            ...
                                            onChange={handleChange}
                                            className="w-full pl-8 pr-4 py-3 border border-gray-300 bg-gray-50 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-gray-900"
                                            placeholder="0.00"
                                        />
                                    </div>
                                    {formData.precio && formData.costo && (
                                        <div className="text-xs text-gray-600 mt-1 flex items-center">
                                            ...
                                            Margen bruto: <span className={`font-semibold ml-1 ${margenBruto >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                                                {margenBruto}%
                                            </span>
                                        </div>
                                    )}
                                ...
                                <motion.div variants={itemVariants} className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <motion.input
                                            ...
                                            className={`w-full pl-8 pr-4 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 ${!permiteComisionVariable
                                    ...
                                    <div className="flex items-center justify-between">
                                            ...
                                            {categoriaSeleccionada ? (
                                                <div className="flex items-center">
                                                    ...
                                                    {permiteComisionVariable
                                                        ...
                                                        : 'No permitida para esta categoría'
                                                    }
                                                </div>
                                            ) : (
                                        ...
                                        {formData.comision_variable && (
                                            <div className="text-xs text-blue-600 font-medium">
                                                {((parseFloat(formData.comision_variable) / parseFloat(formData.precio)) * 100).toFixed(1)}% del precio
                                            </div>
                                        )}
                                    </div>
                                </motion.div>
                            ...
                            >
                                ...
                                <motion.button
                                    ...
                                    className="px-5 py-2.5 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-xl hover:from-blue-600 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 font-medium shadow-md hover:shadow-lg flex items-center space-x-2"
                                >
                                    {loading ? (
                                        <>
                                            <motion.div
