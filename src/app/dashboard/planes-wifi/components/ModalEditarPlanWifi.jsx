...
export default function ModalEditarPlanWifi({ plan, onCerrar, onActualizarPlan, loading, planesExistentes }) {
    ...
    const validarFormulario = () => {
        ...
        // Validar código único (excluyendo el plan actual)
        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-50 flex items-center justify-center">
                ...
                <motion.div
                    ...
                    className="relative bg-white rounded-lg shadow-xl w-full max-w-2xl mx-4 z-10"
                >
