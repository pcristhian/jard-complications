                ...
                <AnimatePresence>
                    ...
                    >
                        <motion.button
                            ...
                            className="flex items-center gap-2 bg-amber-600 hover:bg-amber-700 cursor-pointer text-white pl-3 pr-4 py-2.5 rounded-full font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                        >
