...
const FiltrosVentas = ({
    ...
    const manejarCambioUsuarios = (e) => {
        onFiltroUsuariosChange(e.target.value);
    }
    ...
    //revisar esta funcion si no guarda o muestra registros con fechas del primer y ultimo dia del mes
        ...
        <motion.div
            ...
            <div className="flex flex-wrap items-center justify-between gap-4">
                <div className="flex flex-wrap items-center gap-4">
                    ...
                    <AnimatePresence>
                        {((filtroCategoria || filtroUsuarios || terminoBusqueda || (filtroFecha && filtroFecha.aplicadoManualmente))
                        ) && (
                                <motion.div
