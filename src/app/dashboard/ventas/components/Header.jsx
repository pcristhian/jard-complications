                        ...
                        {!ready ? (
                            ...
                            >
                                <motion.button
                                    ...
                                    className="inline-flex items-center gap-2 bg-indigo-100 hover:bg-slate-700 hover:text-white hover:ring-1 hover:ring-cyan-500 border-slate-700 text-black px-4 py-2 rounded-lg text-sm font-medium transition-colors"
                                >
